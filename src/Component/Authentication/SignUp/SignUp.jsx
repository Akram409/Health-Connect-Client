...
const SignUp = () => {
  ...
  return (
    <div className="bg-[#CFE2FF] min-h-screen">
      <div className="grid grid-cols-2 justify-items-center items-center lg:pt-16 mb-10">
        ...
        <div className="card w-9/12 bg-[#FFFFFF] text-primary-content shadow-2xl rounded-badge">
